...
//{object: "fine_tuning.job", id: "ftjob-AYwT11cpY2sLIaRbs3llYkX4", model: "gpt-3.5-turbo-0125", created_at: 1711377650, finished_at: 1711378224, fine_tuned_model: "ft:gpt-3.5-turbo-0125:abhishek::96fwXrQX", organization_id: "org-hILmMJhWE2V3rB3oGuJuRWMy", result_files: ["file-dmhvhRjM6S4hl55XWj2Q2kbx"], status: "succeeded", validation_file: null, training_file: "file-QxBP3GKvDO7OXsIhI98BhGsn", hyperparameters: {n_epochs: 3, batch_size: 1, learning_rate_multiplier: 2}, trained_tokens: 13017, error: {error: null}, user_provided_suffix: null}
...
async function getResponse() {
   const response = await openai.chat.completions.create({
       model: 'ft:gpt-3.5-turbo-0125:abhishek::96fwXrQX',
       messages: messages
   })
